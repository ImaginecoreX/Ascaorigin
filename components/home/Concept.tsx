...
const Concept = () => {
  return (
    <section className="flex flex-col mobileView:items-center mdUp:flex-row min-h-screen frame-container">
      {/* LEFT SECTION */}
      <div className="mobileView:w-full w-1/3 flex flex-col box-border p-[2rem] gap-2">
      ...
      {/* RIGHT SECTION */}
      <div className="w-2/3  mobileView:w-full box-border py-[40px] px-[50px] grid grid-cols-2  gap-[10px]">
